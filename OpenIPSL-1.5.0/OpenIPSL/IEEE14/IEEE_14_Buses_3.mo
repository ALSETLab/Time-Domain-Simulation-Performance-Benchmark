...
model IEEE_14_Buses_3
  ...
  OpenIPSL.Electrical.Events.PwFault pwFault2(
    ...
    R=0,X=1e-5,
    t1= 20,
    t2= 21.2) annotation (Placement(visible = true, transformation(origin = {73, -57}, extent = {{-7, -7}, {7, 7}}, rotation = 270)));
  ...
  OpenIPSL.Electrical.Events.PwFault pwFault1(R = 0, X = 1e-5,t1 = 80, t2 = 81.2)  annotation(
    Placement(visible = true, transformation(origin = {125, 81}, extent = {{-7, -7}, {7, 7}}, rotation = 270)));
equation
  connect(pwFault1.p, B14.p) annotation(
    Line(points = {{126, 90}, {124, 90}, {124, 98}, {104, 98}, {104, 108}, {104, 108}}, color = {0, 0, 255}));
